...
class MazeEnv(MiniGridEnv):
    ...
    def __init__(
        ...
        obstacle_type=None, # toggles lava CHANGE TO PERCENT CHANCE TO ADD LAVA float(0-0.2)
        ball_level=0, # 0 to 5; increase movable objects CHANGE TO PERCENT CHANCE TO CONVERT TO BALL
        box2ball=0, # CHANCE TO CONVERT TO BALL float(0-1)
        door_level=0, # 0 to 3; 0=no doors, 1=unlocked doors, 2=locked doors, 3=locked doors hidden keys CHANGE TO PERCENT CHANCE TO ADD DOOR
        gap_level=1, # 1 to 3; number of gaps added CHANGE TO PERCENT CHANCE TO KEEP WALL
        agent_start_pos=(1,1),
        agent_start_dir=0,
        seed=0
    ):
